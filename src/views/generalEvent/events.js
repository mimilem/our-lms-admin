					...
					<div className="page-bar">
						<div className="page-title-breadcrumb">
							<div className="pull-left">
								<div className="page-title">General Events</div>
							</div>
							<ol className="breadcrumb page-breadcrumb pull-right">
								<li><i className="fa fa-home"></i>&nbsp;<Link className="parent-item"
										to={'/'}>Home</Link>&nbsp;<i className="fa fa-angle-right"></i>
								</li>
								<li><a className="parent-item" href="#">Events</a>&nbsp;<i className="fa fa-angle-right"></i>
								</li>
								<li className="active">General Events</li>
							</ol>
						</div>
					</div>
					<div className="row">
						<div className="card-box">
							<div className="card-head">
                                ...
                                <button type="button"
									className="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-info m-3">Add Event</button>
                                </div>
							</div>
