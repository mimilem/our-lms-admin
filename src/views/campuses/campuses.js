					...
					<div className="page-bar">
						<div className="page-title-breadcrumb">
							...
							<ol className="breadcrumb page-breadcrumb pull-right">
								...
								<li><a className="parent-item" href="#">Campuses</a>&nbsp;<i className="fa fa-angle-right"></i>
								</li>
								<li className="active">All Campuses List</li>
							</ol>
						</div>
					</div>
					<div className="row">
						<div className="card-box">
							<div className="card-head">
								<header>All Campuses</header>
                                <div className="pull-right">
                                <button type="button"
									className="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-info m-3">Add Campuse</button>
                                </div>
							</div>
									...
									<div className="col-lg-3 col-md-6 col-12 col-sm-6">
										<div className="blogThumb">
											...
											<div className="course-box">
												...
												<button type="button"
													className="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-info">Access Campus</button>
                                                <div className="pull-right">
                                                    <button type="button"
